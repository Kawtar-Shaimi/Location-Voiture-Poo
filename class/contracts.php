...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'ajouter':
                if (!isset($_POST['immatriculation'], $_POST['marque'], $_POST['modele'], $_POST['year']) || !isset($_FILES['img'])) {
                    ...
                    if ($_FILES["img"]["error"] === 4) {
                        ...
                        $uploadResult = handleFileUpload($_FILES['img']);
                        ...
                        if (!$uploadResult['success']) {
                            ...
                            $car->creatvoiture($_POST['immatriculation'], $_POST['marque'], $_POST['modele'], $_POST['year'], $fileName);
                ...
                if (!isset($_POST['immatriculation'], $_POST['marque'], $_POST['modele'], $_POST['year']) || !isset($_FILES['img'])) {
                    ...
                    if ($_FILES["img"]["error"] === 4) {
                        ...
                        if (!$uploadResult['success']) {
                            ...
                            // Insert the data into the database using PDO
                            $car->updateVoiture($_POST['id_voiture'],$_POST['immatriculation'], $_POST['marque'], $_POST['modele'], $_POST['year'], $fileName);
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="car-card rounded-xl shadow-lg overflow-hidden">
                <div class="aspect-w-16 aspect-h-9 bg-gray-200">
                    <img src="uploads/<?= htmlspecialchars($voiture['image']) ?>" 
                        ...
                        <form action="" method="POST"  enctype="multipart/form-data" class="space-y-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="file" name="img" value="${voiture.image}" required
                                           class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
